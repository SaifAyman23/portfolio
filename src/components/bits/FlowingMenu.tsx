...
const MenuItem: React.FC<MenuItemProps> = ({
  ...
  return (
    ...
    >
      <div className="flex cursor-pointer select-none items-center justify-between px-8 py-8 md:px-12" style={{ color: textColor }}>
            ...
            <div className="marquee-part flex shrink-0 items-center" key={idx} style={{ color: marqueeTextColor }}>
              {techs.map((tech) => (
                ...
                >
                  ...
                  {tech.SecondIcon && <tech.SecondIcon aria-hidden="true" className="-ml-6 h-7 w-7 shrink-0" />}
                  {tech.name}
                </span>
              ))}
            </div>
